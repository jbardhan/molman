...
protein = mymm.Apbs()
protein.pqrList.append(os.path.join(os.getcwd(), "neutral_protein.pqr"))
...
protein.add_elecSection(name="solv", molIndex=2, commands = "write atompot flat solv", additional_params_dict=protein_params_hash)
protein_params_hash.update({'sdie':protein.elecParams['pdie']})
protein.add_elecSection(name="ref", molIndex=2, commands = "write atompot flat ref", additional_params_dict=protein_params_hash)
